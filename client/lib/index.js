...
function promisifyAll(Service) {
  promisifyClient(Service.Client.prototype);
  promisifyServer(Service.Server.prototype);
  promisifyMiddleware(Service.Client.prototype);
  promisifyMiddleware(Service.Server.prototype);
}
